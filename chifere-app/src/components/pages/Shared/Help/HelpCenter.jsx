...
const HelpCenter = ({ userRole = 'buyer', onContactSupport }) => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: 'ChiFere supports various payment methods including Credit/Debit cards via Stripe, GCash, PayMaya, and Cash on Delivery. Choose the method that works best for you during checkout.'
    },
    {
      id: 'faq5',
      category: 'shipping',
