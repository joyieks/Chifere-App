...
const TrackOrder = () => {
  ...
  const [order] = useState({
    ...
    delivery: {
      address: 'Barangay Luz, Cebu City, 6000 Cebu, Philippines',
      courier: 'LBC Express',
      ...
      timeline: [
        ...
        {
          time: '2024-01-20 02:15 PM',
          status: 'Payment Confirmed',
          desc: 'Payment received via GCash. Order is now being processed.',
          completed: true
        },
        {
          time: '2024-01-21 09:00 AM',
          status: 'Item Packed',
          desc: 'Your item has been carefully packed and ready for shipment.',
          completed: true
        },
        {
          time: '2024-01-21 03:45 PM',
          status: 'Shipped',
          desc: 'Package has been picked up by LBC Express courier.',
          completed: true
        },
        {
          time: '2024-01-22 11:20 AM',
          status: 'In Transit',
          desc: 'Package is on the way to destination facility.',
          completed: true
        },
        {
          time: 'Expected: 2024-01-25',
              ...
              <div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-sm">
                  ...
                  <div>
                    ...
                    <span className="font-semibold text-blue-600 text-lg">₱{order.total.toLocaleString()}</span>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  {order.items.map((item) => (
                    <div key={item.id} className="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl">
                      ...
                      />
                      <div className="flex-1 min-w-0">
                        <h5 className="font-semibold text-gray-800 text-sm line-clamp-2">{item.name}</h5>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="font-medium text-gray-800 mt-1">
                      <div>Joan Joy Diocampo</div>
                      <div className="text-sm text-gray-600">(+63) 9981921194</div>
                      <div className="text-sm text-gray-600 mt-2">{order.delivery.address}</div>
                    </div>
                  </div>
                  
                  <div className="border-t border-gray-200 pt-4">
                    <span className="text-sm text-gray-500 block">Courier Service</span>
                    <div className="font-medium text-gray-800 mt-1">{order.delivery.courier}</div>
                  </div>
                  ...
                  {order.status === 'delivered' && (
                    <>
                      <button className="w-full px-4 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl hover:from-green-700 hover:to-emerald-700 font-semibold transition-all duration-200">
                        {order.type === 'preloved' ? 'Buy Again' : 'Barter Again'}
                      </button>
