...
import { FiChevronDown, FiPhone, FiSearch, FiBell, FiPackage, FiDollarSign, FiUsers, FiBarChart3, FiSettings, FiLogOut } from 'react-icons/fi';
      ...
      <div className="bg-blue-800 text-white py-2 px-6">
        <div className="container mx-auto flex justify-between items-center text-sm">
          ...
          <div className="flex items-center space-x-4">
            <span>Seller Dashboard - Manage Your Store</span>
            <a href="#" className="underline hover:no-underline">View Analytics</a>
          </div>
          <div className="flex items-center space-x-4">
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button 
              ...
              onClick={() => navigate('/seller/barter')}
            >
              Barter Items
            </button>
            <button 
              className="text-gray-700 hover:text-blue-800 transition bg-gray-100 border border-gray-300 rounded-full px-4 py-2 shadow-sm"
              onClick={() => navigate('/seller/preloved')}
            >
              Preloved Items
            </button>
          </div>
              ...
              <input
                ...
                onKeyDown={e => {
                  if (e.key === 'Enter' && searchQuery.trim()) {
                    navigate(`/seller/search?query=${encodeURIComponent(searchQuery.trim())}`);
                  }
                }}
              />
          ...
          <div className="flex items-center space-x-6">
            ...
            <button className="flex items-center space-x-1 text-gray-700 hover:text-blue-800 transition" onClick={() => navigate('/seller/orders')}>
                <FiPackage size={20} />
                <span className="relative hidden sm:inline">
                    Orders
                </span>
            </button>
            <button className="flex items-center space-x-1 text-gray-700 hover:text-blue-800 transition" onClick={() => navigate('/seller/analytics')}>
              <FiBarChart3 size={20} />
              <span className="relative hidden sm:inline">
                Analytics
              </span>
            ...
            >
              ...
              >
                ...
                <span className="hidden sm:inline font-semibold">Seller</span>
              ...
              {showDropdown && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg py-2 z-50 border border-gray-200 animate-fade-in">
                  <button onClick={handleDashboard} className="block w-full text-left px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-800 rounded transition">Dashboard</button>
                  <button onClick={handleOrders} className="block w-full text-left px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-800 rounded transition">Orders</button>
